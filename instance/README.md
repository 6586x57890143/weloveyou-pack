...
One directory per pack channel. CI zips these and publishes them to Cloudflare Pages; a player
...
`packwiz-installer.jar.sha256`. `scripts/instance-build.py` refuses to build if
they disagree.
